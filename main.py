...
def attack(char_name: str, char_class: str) -> str:
    """Рассчитывает нанесённый урон для каждого класса героя.
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчитывает блокированный урон для каждого класса героя.
    Возвращает соответствующее сообщение.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Рассчитывает урон, нанесённый специальным умением.
    Возвращает соответствующее сообщение.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Инициализирует тренировку.
    Предлагает на выбор тренировать атаку, защиту или спецумение.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает игроку на выбор один из трёх классов героев."""
    approve_choice: str = ''
    char_class: str = ''
